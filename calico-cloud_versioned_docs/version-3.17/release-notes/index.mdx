...
- A Helm Upgrade may fail due to a change in the Installer CRD. To resolve, apply [the crds](https://installer.calicocloud.io/manifests/cc-operator/v1.8.0/crds.yaml) before performing the upgrade.
...
New CLI will now check that it is compatible with the the latest Image Assurance API.
